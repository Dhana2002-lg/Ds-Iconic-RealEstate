...
const images = ["/sandy-beach.png", "/sandy2.png", "/sandy3.png"];
...
const advantages = [
  ...
  "Close to IT Parks & Industrial Hubs",
  "Fast Developing Tourism Corridor",
  "High Appreciation & Growth Potential",
  "Peaceful Environment with Natural Beauty",
  "Star Hotels & Resorts Nearby",
  "TATA Hotels Nearby",
  "Oberoi Hotels Nearby",
];

const investReasons = [
  "High Returns",
  "Future Growth",
  "Beach & Airport Proximity",
  "Tourism Development",
  "Safe & Secure Investment",
];

export default function SandyBeach() {
  ...
  return (
    <div className="bg-[#f8faf8] text-gray-900 overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-[#0ea5e9]/10 blur-[120px]" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[#172554]/10 blur-[120px]" />
      </div>
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute bottom-16 left-6 md:left-16 z-20 max-w-4xl">
          ...
          >
            ...
            <span className="px-5 py-2 rounded-full bg-white/70 text-[#0ea5e9] text-xs tracking-[0.3em] uppercase">
              Premium Beach Venture
            </span>

            {/* ✅ FIXED HERO TITLE SIZE */}
            <h1 className="mt-5 text-4xl md:text-6xl leading-tight text-white">
              Sandy{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0ea5e9] to-[#172554]">
                Beach
              </span>
            </h1>
            ...
            <p className="mt-5 text-white/90 text-sm md:text-base leading-7 max-w-3xl">
              Premium gated community near beach & Bhogapuram International Airport
              designed for luxury lifestyle and future appreciation.
            </p>
            ...
            >
              ...
              <button
                onClick={goToContact}
                className="px-6 py-3 rounded-full bg-gradient-to-r from-[#0ea5e9] to-[#172554] text-white font-semibold"
              >
                Book Site Visit
              </button>
  ...
  {[
    ...
    <div key={l} className="luxury-card p-6 text-center">
      ...
      <div className="text-2xl md:text-4xl font-serif font-bold bg-gradient-to-r from-[#0ea5e9] to-[#172554] bg-clip-text text-transparent">
        {v}
      </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="bg-white/70 backdrop-blur-xl border rounded-[30px] p-8 md:p-12 shadow-xl">
          ...
          <p className="text-[#0ea5e9] uppercase tracking-[0.3em] text-xs">
            Premium Beach Living
          </p>
          ...
          <p className="mt-6 text-gray-600 leading-7 text-sm md:text-base">
            Sandy Beach is a premium plotted development near Bhogapuram beach and airport.
            It offers tourism growth, luxury hotels, and strong appreciation potential.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-14">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          ...
          {features.map((f) => (
            <div key={f} className="p-6 rounded-[25px] bg-white/70 shadow border">
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          {advantages.map((a) => (
            <div key={a} className="p-5 rounded-[20px] bg-white shadow border">

              <h3 className="text-[#0ea5e9] text-base md:text-lg font-semibold">
                {a}
              </h3>
      ...
      <section className="max-w-7xl mx-auto px-6 py-14">
        ...
        <div className="grid md:grid-cols-5 gap-4">
          ...
          {investReasons.map((i) => (
            <div
              key={i}
              className="p-5 rounded-[25px] text-white bg-gradient-to-r from-[#0ea5e9] to-[#172554] text-center"
            >
      ...
      <section className="max-w-5xl mx-auto px-6 pb-20">
        ...
        <div className="rounded-[30px] p-10 text-center bg-gradient-to-r from-[#0ea5e9] to-[#172554] text-white">
